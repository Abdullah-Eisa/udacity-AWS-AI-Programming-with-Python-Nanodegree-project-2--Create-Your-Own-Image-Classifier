...
def save_checkpoint(train_data, model = 0, path = 'checkpoint.pth', structure = 'vgg16', hidden_units = 4096, dropout = 0.2, lr = 0.001, epochs = 1):
...
def load_checkpoint(path = 'checkpoint.pth'):
    ...
    model, _ = nn_prepare(structure, dropout, hidden_units, lr)
